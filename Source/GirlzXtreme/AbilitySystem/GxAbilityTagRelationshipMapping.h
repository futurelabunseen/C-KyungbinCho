...
#include "GxAbilityTagRelationshipMapping.generated.h"

/**
 * FGxAbilityTagRelationship
 *
 * GA에 사용되는 태그 간의 관계를 설정하기 위한 구조체
 */
USTRUCT(Meta = (ShortTooltip = "Struct that defines the relationship between different ability tags."))
struct FGxAbilityTagRelationship
{
	GENERATED_BODY()
 ...
 *
 * GA에 사용되는 태그 간의 관계를 파악하기 위한 클래스
 */
UCLASS(Meta = (ShortTooltip = "Mapping of how ability tags block or cancel other abilities."))
class UGxAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FGxAbilityTagRelationship> AbilityTagRelationships;
};
